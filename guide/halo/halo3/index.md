...
platforms:
  - PC
  - Console
leaderboard: https://haloruns.com/leaderboards/h3/solo/fullgame/Easy
...
Halo 3 is a fun speedgame. You go fast and fly far. Here is a playlist of StuffedCrustGogGamer showing a [basic introduction to running the game on easy](https://youtu.be/M1Nrzs8m0ls). This guide is outdated and in need of a revamp. If you are interested in learning the game on Legendary, check out [This Playlist of Legendary guides by a variety of legendary runners.](https://www.youtube.com/watch?v=hVIUaGI4qnA&list=PLY3qkA_3-TfWGVczNT24hlUZsgnyRN2Gy) These legendary guides are mostly up to date.
...
If a level has a video tutorial it will be linked at the top of each Individual level's page. To see some fullgame runs with commentary, check out [Sorix's 2018 ESA run](https://youtu.be/cuGiggKof84) or [Dark's 2015 ESA run](https://youtu.be/9D4GaxWWmXE) or [The BlazeJp's 2015 SDGQ run](https://youtu.be/8E0a81hfds0). Sorix's run is the most up to date and contains some skips not found in the latter two.

## Version Differences

Halo 3 (H3) originally released on the Xbox 360, this version of H3 is referred to as the Original Game (OG). Halo 3 released as part of the Master Chief Collection is commonly referred to as H3 MCC. There are small differences between the two that are a result of frame rate differences, as well as potentially hardware. Enemies on MCC are more aggressive and notice you more quickly, making legendary more difficult on MCC than on OG. However, momentum is more easily conserved through gravemind and cortana moments on MCC, which makes some skips easier. Animation sequences are also slightly faster on MCC, so the drones on crow's nest come out of their pipe faster on MCC than on OG (for example).

## Level Strategies

- [Sierra 117](levels/sierra117/index.md)
- [Crow's Nest](levels/crowsnest/index.md)
- [Tsavo Highway](levels/tsavohighway/index.md)
- [The Storm](levels/thestorm/index.md)
- [Floodgate](levels/floodgate/index.md)
- [The Ark](levels/theark/index.md)
- [The Covenant](levels/thecovenant/index.md)
- [Cortana](levels/cortana/index.md)
- [Halo (Halo 3)](levels/halo/index.md)
...
{{#widget:Snippet\|file=\|thumbnail\|left\|caption=Cone launch using a plasma grenade and brute shot combined}}
...
{{#widget:Snippet\|file=\|thumbnail\|left\|caption=A player Butterflying to "ride" a Drone.}}
...
More information about Brutes can be found [here](http://halo.wikia.com/wiki/Jiralhanae)
...
sp = Shield Points bp = Body points

### Weapon Damage per Hit ordered from most damage to least damage

- Spartan Laser: 284.0 dmg (This value is for the full length of the laser shot. At roughly 22 dmg/frame for 13 frames.)
...
- Brute Shot: 38.0 dmg
- Battle Rifle: 18.0 dmg/burst (6.0 dmg/bullet)
- Machine Gun Turret: 15.0 dmg
- Magnum: 15.0 dmg
- Plasma Rifle: 14.5 dmg(sp) & 3.5 dmg(bp)
- Carbine: 10.0 dmg
- Plasma Pistol: 10.0 dmg(sp) & 2.4 dmg(bp) (charged-shot deals ∞ dmg(sp) and 0 dmg(bp))
- Spiker: 9.0 dmg
...
### Reload/Cooldown times (approximate values) ordered from longest to shortest
