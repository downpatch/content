---
title: The Storm
description: Speedrun strategy page for The Storm in Halo 3, including route notes, tricks, and leaderboard links.
...
This level has a video [tutorial using beginner strats](https://youtu.be/5jCt8Wbnmcw) here

[Click here](https://haloruns.com/records?lb=0304) to go to a table which shows the WR times and video links for this level on both Easy and Legendary.
