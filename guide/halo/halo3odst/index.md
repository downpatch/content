...
platforms:
  - PC
  - Console
leaderboard: https://haloruns.com/leaderboards/odst/solo/fullgame/Easy
...
As a speedgame, Halo 3: ODST is not as popular as the others in the series. Levels tend to be linear and there is a lot of walking between levels. Halo 3: ODST uses the same engine as [Halo 3](../halo3/index.md), meaning that many Halo 3 tricks should be equally possible in ODST. However, tricks which rely on equipment are not possible, as enemies do not drop equipment.
...
Unlocking 8 audio logs in Mombasa Streets will allow you to use Mongooses. See [this link](http://imgur.com/MucBAAm) for the locations of all audio logs in Mombasa Streets. Some will not be able to be unlocked until you progress through the game. Audio logs ready to be collected will glow yellow in the VISR.
...
- [Prepare to Drop](levels/preparetodrop/index.md)
- [Mombasa Streets](levels/mombasastreets/index.md)
- [Tayari Plaza](levels/tayariplaza/index.md)
- [Uplift Reserve](levels/upliftreserve/index.md)
- [Kizingo Boulevard](levels/kizingoboulevard/index.md)
- [ONI Alpha Site](levels/onialphasite/index.md)
- [NMPD HQ](levels/nmpdhq/index.md)
- [Kikowani Station](levels/kikowanistation/index.md)
- [Data Hive](levels/datahive/index.md)
- [Coastal Highway](levels/coastalhighway/index.md)
