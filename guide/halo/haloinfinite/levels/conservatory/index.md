---
title: Conservatory
description: Speedrun strategy page for Conservatory in Halo Infinite, including route notes, tricks, and leaderboard links.
...
Examples of every trick mentioned here can be found on either the [Individual Level](https://haloruns.com/leaderboards/infinite/Solo/Conservatory/Easy) or the [Full Game](https://haloruns.com/leaderboards/infinite/Solo/fullgame/Easy) Records page. There are also multiple video tutorials for specific tricks indicated on this page. Be sure to check \#infinite-links in the Haloruns discord.

Video tutorials for this level can be found here:

- [Conservatory Tutorial by Alicenuga.](https://youtu.be/VbLamFRIiYY)

## Mission Start

The remaining sections are WiP.
