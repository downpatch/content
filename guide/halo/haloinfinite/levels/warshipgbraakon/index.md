...
Examples of every trick mentioned here can be found on either the [Individual Level](https://haloruns.com/leaderboards/infinite/Solo/Warship%20Gbraakon/Easy) or the [Full Game](https://haloruns.com/leaderboards/infinite/Solo/fullgame/Easy) Records page. There are also multiple video tutorials for specific tricks indicated on this page. Be sure to check \#infinite-links in the Haloruns discord.

Video tutorials for this level can be found here:

- [Warship Gbraakon Tutorial by B34RFAC3.](https://www.youtube.com/watch?v=zpi-WL-d1Qw)
- [Downpatch IL Tutorial by LiamTrader.](https://youtu.be/yJ3VHaHMLJQ)
